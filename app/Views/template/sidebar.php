            ...
            <div class="list-group list-group-flush my-3">
                ...
                <div class="accordion" id="accordionExample">
                        ...
                        <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                        <a href="<?php echo base_url('common/articles/add_articles') ;?>" class="bg-transparent second-text fw-bold text-decoration-none"><i
                                                class="fas fa-sort-amount-up-alt me-2"></i>Transactions</a><br>
                                        <a href="<?php echo base_url('common/articles/stock') ;?>" class="bg-transparent second-text fw-bold text-decoration-none"><i
                                                class="fas fa-sort-amount-up-alt me-2"></i>Etat des ventes</a>
                                </div>
                        </div>
                        </div>
                        <div class="accordion-item">
