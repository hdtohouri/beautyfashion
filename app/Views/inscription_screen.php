                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Bienvenue chez BeautyFashion</h1>
                                        <?php
                                        if( isset($validation) )
                                    ...
                                    <form class="user" method="post" action="<?php echo base_url('common/login/register'); ?>" autocomplete="off">
                                         <div class="mb-4 form-group">
                                            <input type="text" class="form-control form-control-user" id="Name" name="Name" placeholder="Saisir Votre Nom Complet" autofocus />
                                        </div>
                                        <div class="mb-4 form-group">
